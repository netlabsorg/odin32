 ...
 */
    ...
    do
        ...
        call lineout sIncFile, '################################################################################'
        call lineout sIncFile, 'PATH_WIN32K      =' directory();
        call lineout sIncFile, 'PATH_KKRNLLIB    =' directory()'\kKrnlLib';
        call lineout sIncFile, ''

        call lineout sIncFile, '################################################################################'
        call lineout sIncFile, '# Base directory of the DDK (i.e. \DDK\BASE not \DDK for DDK v4.0+).'
        call lineout sIncFile, '################################################################################'
        ...
        call lineout sIncFile, 'PATH_DDKBASE     =' sDDK
        call lineout sIncFile, ''
        ...
        call lineout sIncFile, 'PATH_TOOLKIT     =' sTLKT
        call lineout sIncFile, ''
        ...
        call lineout sIncFile, 'PATH_VAC          =' sVA
        call lineout sIncFile, ''
        ...
        call lineout sIncFile, 'PATH_MSC          =' sMSC
        call lineout sIncFile, ''
