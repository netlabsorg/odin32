/* $Id: probkrnl.c,v 1.20.4.5 2000-08-15 07:03:23 bird Exp $
 *
...
{/* iFound     cchName                  offObject    usSel     fType    */
 /*      iObject      achName                 ulAddress  cProlog        */
    ...
    {FALSE, -1, 11, "ptda_module",          -1,  -1,  -1,  -1, EPT_VARIMPORT16},   /* 29 */
...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        printf16("/* $Id: probkrnl.c,v 1.20.4.5 2000-08-15 07:03:23 bird Exp $\n"
                 "*\n"
