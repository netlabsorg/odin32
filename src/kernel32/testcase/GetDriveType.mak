# $Id: GetDriveType.mak,v 1.2 2002-04-16 00:06:35 bird Exp $
#
...
!else
testcase:
    @$(ECHO) $(CLRFIL)GetDriveType$(CLRTXT) - Testcases.$(CLRRST)
# plain 'c:' styled input
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_UNUSED):=DRIVE_NO_ROOT_DIR
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_FLOPPY):=DRIVE_REMOVABLE
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_FIXED):=DRIVE_FIXED
!if "$(ODIN32_TESTCASE_DRIVE_CDROM)" != ""
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_CDROM):=DRIVE_CDROM
!endif
!if "$(ODIN32_TESTCASE_DRIVE_NETWORK)" != ""
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_NETWORK):=DRIVE_REMOTE
!endif
!if "$(ODIN32_TESTCASE_DRIVE_RAMDISK)" != ""
    $(TARGET) $(ODIN32_TESTCASE_DRIVE_RAMDISK):\=DRIVE_RAMDISK
!endif
