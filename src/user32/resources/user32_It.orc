...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&Info su Odin ...", 61761
}

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
{
 MENUITEM "&Ripristina\tAlt-F5", 61728
 MENUITEM "&Muovi\tAlt-F7", 61456
 MENUITEM "&Dimensione\tAlt-F8", 61440
 MENUITEM "Mi&nimizza\tAlt-F9", 61472
 MENUITEM "Ma&ssimizza\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Chiudi\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "C&ambia a ...\tCtrl-Esc", 61744
