...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&Pri Odin ...", 61761
}

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
{
 MENUITEM "&Renormaligu\tAlt-F5", 61728
 MENUITEM "&Movi\tAlt-F7", 61456
 MENUITEM "&Grando\tAlt-F8", 61440
 MENUITEM "E&tigu\tAlt-F9", 61472
 MENUITEM "&Egigu\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Fermu\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Alia tasko ...\tCtrl-Esc", 61744
