...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&O programu Odin", 61761
}

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
{
 MENUITEM "&Obnov\tAlt-F5", 61728
 MENUITEM "Pøe&suò\tAlt-F7", 61456
 MENUITEM "&Zmìò velikost\tAlt-F8", 61440
 MENUITEM "Mi&nimalizuj\tAlt-F9", 61472
 MENUITEM "Ma&ximalizuj\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Zavøi\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Pøepni do jiné úlohy...\tCtrl-Esc", 61744
