...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&Quant a Odin...", 61761
 MENUITEM SEPARATOR
 MENUITEM "&Afegir marca en l'historial de depurament", 61762
}

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
{
 MENUITEM "&Restauració\tAlt-F5", 61728
 MENUITEM "&Desplaçament\tAlt-F7", 61456
 MENUITEM "&Grandària\tAlt-F8", 61440
 MENUITEM "Mí&nima\tAlt-F9", 61472
 MENUITEM "Mà&xima\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Tancar\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "C&anvi de tasca...\tCtrl-Esc", 61744
