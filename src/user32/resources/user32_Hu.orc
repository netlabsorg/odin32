...
BEGIN
 ...
 MENUITEM SEPARATOR
 MENUITEM "A &Odin-ról ...", 61761
END

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
BEGIN
 MENUITEM "&Visszaállítás\tAlt-F5", 61728
 MENUITEM "&Mozgatás\tAlt-F7", 61456
 MENUITEM "Á&tméretezés\tAlt-F8", 61440
 MENUITEM "&Kicsinyítés\tAlt-F9", 61472
 MENUITEM "&Nagyítás\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Bezárás\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "Ta&szkváltás...\tCtrl-Esc", 61744
...
BEGIN
        ...
        BEGIN
                ...
                MENUITEM SEPARATOR
                MENUITEM "M&inden kijelölése", EM_SETSEL
        END
END
