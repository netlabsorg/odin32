...
**
** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/Voodoo1/glide/Attic/fxglide.h,v 1.1 2000-02-18 10:43:05 sandervl Exp $
** $Log: fxglide.h,v $
** Revision 1.1  2000-02-18 10:43:05  sandervl
...
typedef struct GrGC_s
{
  ...
  struct dataList_s dataList[20+12*GLIDE_NUM_TMU+3];/* add 3 for:
						       fbi-tmu0 trans
						       tmu0-tmu1 trans
						       tmu1-tmu2 trans
						       */
...
void _grErrorOs2Callback( const char *s, FxBool fatal );
