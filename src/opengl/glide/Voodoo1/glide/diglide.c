...
**
** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/Voodoo1/glide/Attic/diglide.c,v 1.1 2000-02-18 10:43:03 sandervl Exp $
** $Log: diglide.c,v $
** Revision 1.1  2000-02-18 10:43:03  sandervl
...
{
  extern void _System _single_precision_asm(void);
  extern void _System _double_precision_asm(void);
  ...
  switch (hintType) {
    ...
    case GR_HINT_FPUPRECISION:
      hints ? _double_precision_asm() : _single_precision_asm();
      break;
