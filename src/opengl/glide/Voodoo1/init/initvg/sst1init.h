...
extern "C" {
...
#ifdef SST1INIT_ALLOCATE
  static char headersIdent[] = "@#%InitHeaders $Revision: 1.1 $";
  ...
  PciRegister SST1_PCI_INIT_ENABLE   = { 0x40, 4, READ_WRITE };
  PciRegister SST1_PCI_BUS_SNOOP0    = { 0x44, 4, WRITE_ONLY };
  PciRegister SST1_PCI_BUS_SNOOP1    = { 0x48, 4, WRITE_ONLY };
  PciRegister SST1_PCI_CFG_STATUS    = { 0x4c, 4, READ_ONLY };
  PciRegister SST1_PCI_VCLK_ENABLE   = { 0xc0, 4, WRITE_ONLY };
  PciRegister SST1_PCI_VCLK_DISABLE  = { 0xe0, 4, WRITE_ONLY };
