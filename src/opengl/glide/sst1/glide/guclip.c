...
**
** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/sst1/glide/guclip.c,v 1.1 2000-02-25 00:31:19 sandervl Exp $
** $Log: guclip.c,v $
           ...
           (const GrVertex *a, const GrVertex *b, const GrVertex *c ))
{
  ...
  defined ( __DJGPP__ ) || defined (__GNUC__) || defined(__OS2__)
