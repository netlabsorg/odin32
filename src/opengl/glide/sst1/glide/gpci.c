 ...
 **
 ** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/sst1/glide/gpci.c,v 1.1 2000-02-25 00:31:17 sandervl Exp $
 ** $Log: gpci.c,v $
...
extern FxU32 _cpu_detect_asm(void);
...
#else
#ifdef __OS2__
  grErrorSetCallback(_grErrorOs2Callback);
#else
