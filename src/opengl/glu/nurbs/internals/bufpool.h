/* $Id: bufpool.h,v 1.1 2000-02-09 08:49:49 jeroen Exp $ */
/*
 ...
 * bufpool.h
 *
 * $Date: 2000-02-09 08:49:49 $ $Revision: 1.1 $
 * $Header: /home/ktk/tmp/odin/odin32xp/src/opengl/glu/nurbs/internals/bufpool.h,v 1.1 2000-02-09 08:49:49 jeroen Exp $
 */
...
public:
    ...
    inline void *       operator new( size_t, const char *filename, size_t lineno, Pool &);
    inline void *       operator new( size_t, const char *filename, size_t lineno, void *);
    inline void *       operator new( size_t s , const char *filename, size_t lineno)
                                { return ::new char[s]; }
#else
...
inline void *
#ifdef __DEBUG_ALLOC__
PooledObj::operator new( size_t, const char *filename, size_t lineno, Pool &pool)
#else
