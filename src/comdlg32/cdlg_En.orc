/* $Id: cdlg_En.orc,v 1.2 2000-03-26 16:31:39 cbratschi Exp $ */
...
FONT 8, "helv"
{
    ...
    LTEXT       "" , IDC_TOOLBARSTATIC, 188, 2, 82, 17, NOT WS_GROUP | NOT WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN
    LISTBOX     IDC_SHELLSTATIC,4,20,272,85, LBS_SORT | LBS_NOINTEGRALHEIGHT | LBS_MULTICOLUMN | WS_HSCROLL | NOT WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN
...
STRINGTABLE DISCARDABLE
{
    ...
    IDS_CREATEFOLDER_DENIED "Unable to create the folder \"%s\"\n\nAccess is denied."
    IDS_FILEOPEN_CAPTION    "Open"
