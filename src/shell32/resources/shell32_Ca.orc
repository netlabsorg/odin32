...
FONT 10, "System"
{
 DEFPUSHBUTTON "D'Acord", IDOK, 156, 147, 50, 12, WS_TABSTOP
 LISTBOX 99, 8, 85, 137, 82, LBS_NOTIFY | WS_VSCROLL | WS_BORDER
 ICON "", 1088, 189, 50, 14, 16
 LTEXT "", 100, 8, 50, 137, 33
 LTEXT "Odin ha estat construit per (%d.%d.%d, %s):", 98, 8, 75, 137, 10
...
FONT 10, "System"
{
 ...
 LTEXT "Odin ha estat construit per:", 98, 8, 55, 137, 10
}
#endif
