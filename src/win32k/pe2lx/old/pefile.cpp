/* $Id: pefile.cpp,v 1.1 1999-10-06 18:50:56 bird Exp $ */
...
//******************************************************************************
//******************************************************************************
static char *UnicodeToFixedAsciiString(int length, WCHAR *NameString)
{
...
/* function gets the function header for a section identified by type */
...
/**
 * Get Section Header for the given RVA - returns boolean according to the result.<br>
