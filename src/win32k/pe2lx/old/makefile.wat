...
#
#===================================================================
INC     = $(%WATCOM)\h;m:\coding\toolkit\h;.;..\..\include
DEF     =
!ifndef %RELEASE
#DBGFLG   = -dDEBUG=1
DBGFLG =
...
CFLAGS  = -w4 -e25 -otexan -d2 -bm -ez -mf -i$(INC) -5r -bt=os2 -zq
...
LFLAGS   = sys os2v2 op m d all op st=131072 op maxe=25 op q
...
#
#===================================================================
all: setver.exe getver.exe $(TARGET).EXE


getver.exe: getver.c ..\..\include\version.h
        wcl386 /W4 /Omaxet /zp4 /5r /zq /i$(INC) getver.c
        copy getver.exe ..

setver.exe: setver.c ..\..\include\version.h
        wcl386 /W4 /Omaxet /zp4 /5r /zq /i$(INC) setver.c
        copy setver.exe ..
