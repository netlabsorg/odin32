/* $Id: kAVL.h,v 1.1 2001-09-14 01:50:16 bird Exp $
 *
...
PAVLPVNODECORE      KLIBCALL AVLPVGetWithAdjecentNodes(PPAVLPVNODECORE ppTree, AVLPVKEY Key, PPAVLPVNODECORE ppLeft, PPAVLPVNODECORE ppRight);
...
PAVLULNODECORE      KLIBCALL AVLULGetWithAdjecentNodes(PPAVLULNODECORE ppTree, AVLULKEY Key, PPAVLULNODECORE ppLeft, PPAVLULNODECORE ppRight);
...
/* since ULONG and PVOID is of the same size don't duplicated the code! */
    ...
    #pragma map(AVLULGetWithAdjecentNodes , "AVLPVGetWithAdjecentNodes")
...
PAVLULMNODECORE     KLIBCALL AVLULMGetWithAdjecentNodes(PPAVLULMNODECORE ppTree, AVLULMKEY Key, PPAVLULMNODECORE ppLeft, PPAVLULMNODECORE ppRight);
