...
NODEF_DEBUGWRAP20(GetWinMetaFileBits)
...
NODEF_DEBUGWRAP8(GetDeviceGammaRamp)
DEBUGWRAP12(GetKerningPairsA)
DEBUGWRAP12(GetKerningPairsW)
NODEF_DEBUGWRAP12(GetLogColorSpaceA)
NODEF_DEBUGWRAP12(GetLogColorSpaceW)
