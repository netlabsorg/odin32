...
#ifdef __WIN32OS2__
		*(DWORD *)&icf.GetData = 0xdead4242;
		*(DWORD *)&icf.PutData = 0xdead4243;
#else
...
#ifdef __WIN32OS2__
LONG WINAPI AVIStreamTimeToSample (PAVISTREAM pavi, LONG lTime)
{
    return 0;
}

LONG WINAPI AVIStreamSampleToTime (PAVISTREAM pavi, LONG lSample)
{
    return 0;
}
#endif
