...
BEGIN
  ...
  PUSHBUTTON    "&Apply", IDC_APPLY_BUTTON,112,122,50,14
...
FONT 8, "MS Sans Serif"
BEGIN
  DEFPUSHBUTTON "Finish",  IDC_FINISH_BUTTON,119,26,50,14
  DEFPUSHBUTTON "&Next >", IDC_NEXT_BUTTON,62,26,50,14
  PUSHBUTTON    "< &Back", IDC_BACK_BUTTON,12,26,50,14
