...
; void _Optlink DDrawRGB555to565 (WORD *dest, WORD *src, ULONG num);

	PUBLIC DDrawRGB555to565

DDrawRGB555to565 PROC NEAR
...
DDrawRGB555to565 ENDP

	PUBLIC DDrawRGB565to555

DDrawRGB565to555 PROC NEAR
...
DDrawRGB565to555 ENDP

; void _Optlink DDrawRGB555to565MMX(WORD *dest, WORD *src, ULONG num);

	PUBLIC DDrawRGB555to565MMX

DDrawRGB555to565MMX PROC NEAR
	push	esi
	push	edi
	cld
...
DDrawRGB555to565MMX ENDP


; void _Optlink DDrawRGB565to555MMX(WORD *dest, WORD *src, ULONG num);

	PUBLIC DDrawRGB565to555MMX

DDrawRGB565to555MMX PROC NEAR
	push	esi
	push	edi
	cld
