# $Id: odin32.rel.emx.mk,v 1.5 2001-07-29 18:58:53 sandervl Exp $
...
CFLAGS           = -Zomf -mprobe -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CTARGETFLAGS)
CXXFLAGS         = -Zomf -mprobe -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS)
CXXFLAGS_ODINCRT = -Zomf -mprobe -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS)
CFLAGS_WIN32APP  = -Zomf -mprobe -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CTARGETFLAGS)
CXXFLAGS_WIN32APP= -Zomf -mprobe -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS) $(CXXEXCEPTIONS)
