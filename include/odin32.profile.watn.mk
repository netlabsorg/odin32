# $Id: odin32.profile.watn.mk,v 1.1 2001-10-01 01:19:57 bird Exp $

#
# Odin32 API
#
#       PROFILE makefile for the Watcom C/C++ compiler environment. (NMAKE)
#
...
CFLAGS           = -w4 -wcd=726 -e25 -od -d2 -hw -bm -mf -5r -bt=os2 -zq -fp5 -fpi87     -et $(CTARGET)   $(DLLRTL)
CXXFLAGS         = -w4 -wcd=726 -e25 -od -d2 -hw -bm -mf -5r -bt=os2 -zq -fp5 -fpi87 -xd -et $(CXXTARGET) $(DLLRTL)
CXXFLAGS_ODINCRT = -w4 -wcd=726 -e25 -od -d2 -hw -bm -mf -5r -bt=os2 -zq -fp5 -fpi87 -xd -et $(CXXTARGET)
CFLAGS_WIN32APP  = -w4 -wcd=726 -e25 -od -d2 -hw -bm -mf -5r -bt=os2 -zq -fp5 -fpi87     -et $(CTARGET)
CXXFLAGS_WIN32APP= -w4 -wcd=726 -e25 -od -d2 -hw -bm -mf -5r -bt=os2 -zq -fp5 -fpi87     -et $(CXXTARGET)
