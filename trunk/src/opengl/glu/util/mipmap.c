...
** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glu/util/mipmap.c,v 1.1 2000-02-09 08:47:12 jeroen Exp $
*/

#include "gluos.h"
#include <assert.h>
#include "gl.h"      /* FIXME: create a 'global' include dir for this stuff*/
...
static GLboolean isLegalInternalFormat(GLenum internalFormat)
{
   switch (internalFormat) {
      ...
      case GL_RGBA16:
         ...
         else if (gluCheckExtension((const GLubyte *)"GL_EXT_texture",
       ...
       switch(type) {
           case GL_UNSIGNED_BYTE:
               ...
               halveImage3D(cmpts,extractUbyte,shoveUbyte,
                 ...
                 halveImage_ubyte(cmpts,newWidth,newHeight,
                                  (GLubyte *)srcImage,(GLubyte *)dstImage,
                                  elementSize,rowSize,groupSize);
               }
               break;
           case GL_BYTE:
               ...
               halveImage3D(cmpts,extractSbyte,shoveSbyte,
                 ...
                 halveImage_byte(cmpts,newWidth,newHeight,
                                 (GLbyte *)srcImage,(GLbyte *)dstImage,
                                  elementSize,rowSize,groupSize);
               }
               break;
           case GL_UNSIGNED_SHORT:
               ...
               halveImage3D(cmpts,extractUshort,shoveUshort,
                 ...
                 halveImage_ushort(cmpts,newWidth,newHeight,
                                   (GLushort *)srcImage,(GLushort *)dstImage,
                                   elementSize,rowSize,groupSize,myswapBytes);
               }
               break;
           case GL_SHORT:
               ...
               halveImage3D(cmpts,extractSshort,shoveSshort,
                 ...
                 halveImage_short(cmpts,newWidth,newHeight,
                                  (GLshort *)srcImage,(GLshort *)dstImage,
                                  elementSize,rowSize,groupSize,myswapBytes);
               }
               break;
           case GL_UNSIGNED_INT:
               ...
               halveImage3D(cmpts,extractUint,shoveUint,
                 ...
                 halveImage_uint(cmpts,newWidth,newHeight,
                                 (GLuint *)srcImage,(GLuint *)dstImage,
                                 elementSize,rowSize,groupSize,myswapBytes);
               }
               break;
           case GL_INT:
           ...
           case GL_FLOAT:
               ...
               halveImage3D(cmpts,extractFloat,shoveFloat,
                 ...
                 halveImage_float(cmpts,newWidth,newHeight,
                                  (GLfloat *)srcImage,(GLfloat *)dstImage,
                                  elementSize,rowSize,groupSize,myswapBytes);
               }
               break;
           case GL_UNSIGNED_BYTE_3_3_2:
