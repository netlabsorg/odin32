...
;;
;; $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/Voodoo1/glide/Attic/xdraw96.asm,v 1.1 2000-02-18 10:43:17 sandervl Exp $
;; $Revision: 1.1 $
;; $Log: xdraw96.asm,v $
;; Revision 1.1  2000-02-18 10:43:17  sandervl
...
fifo    EQU     <edi>       ; points to next entry in fifo
