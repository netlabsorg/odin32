...
**
** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/Voodoo1/glide/Attic/guclip.c,v 1.1 2000-02-18 10:43:12 sandervl Exp $
** $Log: guclip.c,v $
** Revision 1.1  2000-02-18 10:43:12  sandervl
           ...
           (const GrVertex *a, const GrVertex *b, const GrVertex *c ))
{
  ...
  defined ( __DJGPP__ ) || defined (__GNUC__) || defined(__IBMCPP__) || defined(__IBMC__)
