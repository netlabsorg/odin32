 ...
 **
 ** $Header: /home/ktk/tmp/odin/2007/netlabs.cvs/odin32/src/opengl/glide/Voodoo1/glide/Attic/gpci.c,v 1.1 2000-02-18 10:43:09 sandervl Exp $
 ** $Log: gpci.c,v $
 ** Revision 1.1  2000-02-18 10:43:09  sandervl
...
#if (GLIDE_PLATFORM & GLIDE_OS_WIN32) || defined(__WIN32OS2__)
...
FxU32 GR_CDECL _cpu_detect_asm(void);
...
_GlideInitEnvironment( void )
{
  ...
  grErrorSetCallback((GrErrorCallbackFnc_t)_grErrorOs2Callback);
#else
