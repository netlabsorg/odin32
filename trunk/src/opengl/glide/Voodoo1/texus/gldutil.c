                                  ...
                                  FxBool trilinear )
{
  ...
  switch( aspect )
    {
    case 64:
      gr_aspect = GR_ASPECT_8x1;
      longest_side = texture->width;
      break;
    case 32:
      gr_aspect = GR_ASPECT_4x1;
      longest_side = texture->width;
      break;
    case 16:
      gr_aspect = GR_ASPECT_2x1;
      longest_side = texture->width;
      break;
    case 8:
      gr_aspect = GR_ASPECT_1x1;
      longest_side = texture->width;
      break;
    case 4:
      gr_aspect = GR_ASPECT_1x2;
      longest_side = texture->height;
      break;
    case 2:
      gr_aspect = GR_ASPECT_1x4;
      longest_side = texture->height;
      break;
    case 1:
      gr_aspect = GR_ASPECT_1x8;
      longest_side = texture->height;
      break;
    }
#endif /* GLIDE3 */
  ...
  for( i = 0; i < 16; i++ )
    {
      ...
      if( !texture->data[i] )
        break;
      tmp = texture->data[i];
      guTexDownloadMipMapLevel( mmid, lod, (const void **) &tmp );
      lod++;
    }
