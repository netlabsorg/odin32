/* $Id: mkcalltab.c,v 1.5 2001-02-21 07:49:19 bird Exp $
 *
...
int GenerateCalltab(void)
{
     ...
     * Write Start of file.
     */
    printf16("; $Id: mkcalltab.c,v 1.5 2001-02-21 07:49:19 bird Exp $\n"
             ";\n"
    ...
    for (i = 0; i < NBR_OF_KRNLIMPORTS; i++)
    {
        ...
        else if (!(aImportTab[i].fType & (EPT_PROCIMPORT | EPT_VARIMPORT | EPT_NOT_REQ)))
        {   /* Overload procedure (Overloader function) */
