/* $Id: MkCallTab.c,v 1.6 2002-12-16 00:46:47 bird Exp $
 *
...
int GenerateCalltab(void)
{
     ...
     * Write Start of file.
     */
    printf("; $Id: MkCallTab.c,v 1.6 2002-12-16 00:46:47 bird Exp $\n"
           ";\n"
...
int findNextOrdinal(int iOrd, char *pszName, char *pszNameExp, int *pfType, int *piIndex)
{
    ...
    for (i = 0; i < sizeof(aEntries) / sizeof(aEntries[0]); i++)
    {
        ...
        {
            printf("Fatal Error: Duplicate ordinal detected (ord=%d)\n", iOrdRet);
