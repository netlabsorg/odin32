...
//******************************************************************************
//******************************************************************************
ULONG Win32Window::MsgPosChanging(LPARAM lp)
{
...
//******************************************************************************
//******************************************************************************
ULONG Win32Window::MsgPosChanged(LPARAM lp)
{
...
BOOL Win32Window::SetWindowPos(HWND hwndInsertAfter, int x, int y, int cx, int cy, UINT fuFlags)
{
   ...
   {
      Win32Window *wndBehind = Win32Window::GetWindowFromHandle(swp.hwndInsertBehind);
