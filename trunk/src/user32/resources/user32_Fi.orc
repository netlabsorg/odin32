...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&Tietoja Odinista...", 61761
 MENUITEM SEPARATOR
...
{
 MENUITEM "&Palauta\tAlt-F5", 61728
 MENUITEM "Sii&rr‰\tAlt-F7", 61456
 MENUITEM "&Muuta kokoa\tAlt-F8", 61440
 MENUITEM "P&ienenn‰\tAlt-F9", 61472
 MENUITEM "S&uurenna\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Sulje\tAlt+F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Vaihda...\tCtrl+Esc", 61744
