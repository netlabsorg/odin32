...
{
 MENUITEM "&Restaurar\tAlt-F5", 61728
 MENUITEM "&Mover\tAlt-F7", 61456
 MENUITEM "&Tamaño\tAlt-F8", 61440
 MENUITEM "Mi&nimizar\tAlt-F9", 61472
 MENUITEM "Ma&ximizar\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Cerrar\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "Cam&biar a ...\tCtrl-Esc", 61744
