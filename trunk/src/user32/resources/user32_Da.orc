...
SYSMENU MENU LOADONCALL MOVEABLE DISCARDABLE
{
 ...
 MENUITEM SEPARATOR
 MENUITEM "&Om Odin ...", 61761
 MENUITEM SEPARATOR
 MENUITEM "Sæt &mærke i debug loggen", 61762
}

SYSMENUWARP MENU LOADONCALL MOVEABLE DISCARDABLE
{
 MENUITEM "&Genopret\tAlt-F5", 61728
 MENUITEM "&Flyt\tAlt-F7", 61456
 MENUITEM "&Størrelse\tAlt-F8", 61440
 MENUITEM "Mi&nimer\tAlt-F9", 61472
 MENUITEM "Ma&ximer\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Luk\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Skift til ...\tCtrl-Esc", 61744
