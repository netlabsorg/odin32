...
NODEF_DEBUGWRAP8(PathBuildRootAW)
DEBUGWRAP4(PathFindExtensionAW)
DEBUGWRAP4(PathAddBackslashAW)
NODEF_DEBUGWRAP4(PathRemoveBlanksAW)
NODEF_DEBUGWRAP4(PathFindFileNameAW)
NODEF_DEBUGWRAP4(PathRemoveFileSpecAW)
NODEF_DEBUGWRAP8(PathAppendAW)
DEBUGWRAP12(PathCombineAW)
NODEF_DEBUGWRAP4(PathStripPathAW)
DEBUGWRAP4(PathIsUNCAW)
DEBUGWRAP4(PathIsRelativeAW)
NODEF_DEBUGWRAP4(PathIsExeAW)
NODEF_DEBUGWRAP8(DoEnvironmentSubstA)
NODEF_DEBUGWRAP4(PathFileExistsAW)
DEBUGWRAP8(PathMatchSpecAW)
NODEF_DEBUGWRAP20(PathMakeUniqueNameAW)
NODEF_DEBUGWRAP12(PathSetDlgItemPathAW)
DEBUGWRAP4(PathQualifyAW)
NODEF_DEBUGWRAP4(PathStripToRootAW)
NODEF_DEBUGWRAP12(PathResolveAW)
NODEF_DEBUGWRAP4(PathGetArgsAW)
NODEF_DEBUGWRAP8(DoEnvironmentSubstAW)
DEBUGWRAP8(DragAcceptFiles)
DEBUGWRAP4(PathQuoteSpacesAW)
NODEF_DEBUGWRAP4(PathUnquoteSpacesAW)
...
NODEF_DEBUGWRAP4(PathGetShortPathAW)
...
DEBUGWRAP4(PathGetExtensionAW)
NODEF_DEBUGWRAP4(PathIsDirectoryAW)
...
NODEF_DEBUGWRAP8(PathCleanupSpecAW)
...
NODEF_DEBUGWRAP8(SHAddToRecentDocs)
NODEF_DEBUGWRAP8(SHAppBarMessage)
NODEF_DEBUGWRAP4(SHBrowseForFolder)
NODEF_DEBUGWRAP4(SHBrowseForFolderA)
NODEF_DEBUGWRAP4(SHBrowseForFolderW)
...
NODEF_DEBUGWRAP20(SHGetDataFromIDListA)
NODEF_DEBUGWRAP20(SHGetDataFromIDListW)
NODEF_DEBUGWRAP4(PathParseIconLocationAW)
NODEF_DEBUGWRAP4(PathRemoveExtensionAW)
NODEF_DEBUGWRAP4(PathRemoveArgsAW)
DEBUGWRAP4(SHGetDesktopFolder)
DEBUGWRAP20(SHGetFileInfoA)
DEBUGWRAP20(SHGetFileInfoW)
NODEF_DEBUGWRAP4(SHGetInstanceExplorer)
NODEF_DEBUGWRAP4(SHGetMalloc)
NODEF_DEBUGWRAP20(SHGetNewLinkInfo)
DEBUGWRAP8(SHGetPathFromIDListA)
DEBUGWRAP8(SHGetPathFromIDListW)
NODEF_DEBUGWRAP12(SHGetSpecialFolderLocation)
...
NODEF_DEBUGWRAP4(ShellExecuteExA)
NODEF_DEBUGWRAP4(ShellExecuteExW)
...
NODEF_DEBUGWRAP8(PathIsSameRootAW)
NODEF_DEBUGWRAP8(ReadCabinetState)
NODEF_DEBUGWRAP4(WriteCabinetState)
NODEF_DEBUGWRAP16(PathProcessCommandAW)
DEBUGWRAP4(FileIconInit)
NODEF_DEBUGWRAP0(IsUserAdmin)
NODEF_DEBUGWRAP16(SHGetSpecialFolderPathA)
NODEF_DEBUGWRAP8(SHGetSettings)
DEBUGWRAP20(SHGetFolderPathA)
