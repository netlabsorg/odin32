...
ODINDEBUGCHANNEL(SHELL32-SHLMENU)
 ...
 *  exported by name
 */
ODINPROCEDURE1(FileMenu_Destroy,
               HMENU, hmenu)
{
   LPFMINFO menudata;
 ...
 *
 */
ODINFUNCTION6(BOOL, FileMenu_AppendItemA,
              HMENU, hMenu,
              LPCSTR, lpText,
              UINT, uID,
              int, icon,
...
ODINFUNCTION6(BOOL, FileMenu_AppendItemAW,
              HMENU, hMenu,
              LPCVOID, lpText,
              UINT, uID,
              int, icon,
 ...
 */
ODINFUNCTION6(int, FileMenu_InsertUsingPidl,
              HMENU, hmenu,
              UINT, uID,
              LPCITEMIDLIST, pidl,
              UINT, uFlags,
 ...
 */
ODINPROCEDURE1(FileMenu_Invalidate,
               HMENU, hMenu)
{
   FIXME("0x%08x\n",hMenu);
}
 ...
 */
ODINFUNCTION2(HMENU, FileMenu_FindSubMenuByPidl,
              HMENU, hMenu,
              LPCITEMIDLIST, pidl)
{
   FIXME("0x%08x %p\n",hMenu, pidl);
 ...
 * uEnumFlags  any SHCONTF flag
 */
ODINFUNCTION7(int, FileMenu_AddFilesForPidl,
              HMENU, hmenu,
              UINT, uReserved,
              UINT, uID,
              LPCITEMIDLIST, pidl,
 ...
 */
ODINFUNCTION3(BOOL, FileMenu_GetLastSelectedItemPidls,
              UINT, uReserved,
 ...
 */
ODINFUNCTION2(LRESULT, FileMenu_MeasureItem,
              HWND, hWnd,
 ...
 */
ODINFUNCTION2(LRESULT, FileMenu_DrawItem,
              HWND, hWnd,
 ...
 *
 */
ODINFUNCTION1(BOOL, FileMenu_InitMenuPopup,
              HMENU, hmenu)
{
 ...
 */
ODINFUNCTION2(LRESULT, FileMenu_HandleMenuChar,
              HMENU, hMenu,
              WPARAM, wParam)
{
   FIXME("0x%08x 0x%08x\n",hMenu,wParam);
 ...
 *  exported by name
 */
ODINFUNCTION1(BOOL, FileMenu_DeleteAllItems,
              HMENU, hmenu)
{
   MENUITEMINFOA  mii;
   LPFMINFO menudata;
 ...
 *
 */
ODINFUNCTION2(BOOL, FileMenu_DeleteItemByCmd,
              HMENU, hMenu,
              UINT, uID)
{
   MENUITEMINFOA mii;
 ...
 */
ODINFUNCTION2(BOOL, FileMenu_DeleteItemByIndex,
              HMENU, hMenu,
              UINT, uPos)
{
   MENUITEMINFOA mii;
 ...
 */
ODINFUNCTION2(BOOL, FileMenu_DeleteItemByFirstID,
              HMENU, hMenu,
              UINT, uID)
{
   TRACE("0x%08x 0x%08x\n", hMenu, uID);
 ...
 */
ODINFUNCTION1(BOOL, FileMenu_DeleteSeparator,
              HMENU, hMenu)
{
   TRACE("0x%08x\n", hMenu);
   return 0;
 ...
 */
ODINFUNCTION3(BOOL, FileMenu_EnableItemByCmd,
              HMENU, hMenu,
              UINT, uID,
              BOOL, bEnable)
{
 ...
 */
ODINFUNCTION2(DWORD, FileMenu_GetItemExtent,
              HMENU, hMenu,
              UINT, uPos)
{  RECT rect;
 ...
 *
 */
ODINPROCEDURE0(FileMenu_AbortInitMenu)
{
   bAbortInit = TRUE;
}
...
ODINFUNCTION6(HRESULT, Shell_MergeMenus,
              HMENU, hmDst,
              HMENU, hmSrc,
              UINT, uInsert,
              UINT, uIDAdjust,
