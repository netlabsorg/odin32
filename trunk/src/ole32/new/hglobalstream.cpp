/* $Id: hglobalstream.cpp,v 1.1 2000-04-27 22:18:18 davidr Exp $ */
/* 
 *  HGLOBAL Stream implementation functions.
 * 
 * 20/9/99
 * 
		...
		BOOL     fDeleteOnRelease)
{
  ...
  newStream = (HGLOBALStreamImpl *)HeapAlloc(GetProcessHeap(), 0, sizeof(HGLOBALStreamImpl));
