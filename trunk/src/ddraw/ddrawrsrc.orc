...
1 VERSIONINFO
 FILEVERSION 0x04, 0x04, 0x0565,0x0114
 PRODUCTVERSION 0x04, 0x04, 0x0565,0x0114
 FILEFLAGSMASK 0x3fL
 FILEFLAGS 0xaL
 FILEOS 0x10001L
 FILETYPE 0x1L
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription", "DDRAW System dll\0"
            VALUE "FileVersion", "4.04\0"
            VALUE "InternalName", "DDRAW\0"
            VALUE "LegalCopyright", "Copyright (C) 1999-2000\0"
            VALUE "LegalTrademarks", "\0"
            VALUE "OriginalFilename", "DDRAW.DLL\0"
            VALUE "ProductName", "Odin32 - DDRAW\0"
