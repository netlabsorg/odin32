...
// @@@PH numbers are wrong!
#define IOCTL_INTERNAL_GET_PARALLEL_PORT_INFO  CTL_CODE(IOCTL_PARALLEL_PORT_BASE, 0x0005, METHOD_BUFFERED, FILE_ANY_ACCESS)
#define IOCTL_INTERNAL_GET_PARALLEL_PNP_INFO   CTL_CODE(IOCTL_PARALLEL_PORT_BASE, 0x0006, METHOD_BUFFERED, FILE_ANY_ACCESS)
