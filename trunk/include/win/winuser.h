...
#define OBM_CONTEXTHELP     32730 //help button
#define OBM_CONTEXTHELPD    32729 //pressed help button
...
#define PBTF_APMRESUMEFROMFAILURE       0x0001
...
typedef const LPMENUITEMINFOA LPCMENUITEMINFOA;
typedef const LPMENUITEMINFOW LPCMENUITEMINFOW;
...
INT       WINAPI DrawTextExA(HDC,LPCSTR,INT,LPRECT,UINT,LPDRAWTEXTPARAMS);
