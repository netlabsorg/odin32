/* $Id: ntddk.h,v 1.2 1999-06-01 21:57:25 phaller Exp $ */
...
typedef VOID (NTAPI IO_APC_ROUTINE) ( PVOID ApcContext, PIO_STATUS_BLOCK IoStatusBlock, ULONG Reserved );
typedef IO_APC_ROUTINE *PIO_APIO_APC_ROUTINE;
