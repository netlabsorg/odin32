...
# Odin32 API
#
#       RELEASE makefile for the Watcom C/C++ compiler environment. (NMAKE)
#
...
CFLAGS           = -w4 -wcd=726 -e25 -obmiklrtf+ -bm -mf -5r -bt=os2 -zq -fp5 -fpi87 -s     $(CTARGET)   $(DLLRTL)
CXXFLAGS         = -w4 -wcd=726 -e25 -obmiklrtf+ -bm -mf -5r -bt=os2 -zq -fp5 -fpi87 -s -xd $(CXXTARGET) $(DLLRTL)
CXXFLAGS_ODINCRT = -w4 -wcd=726 -e25 -obmiklrtf+ -bm -mf -5r -bt=os2 -zq -fp5 -fpi87 -s -xd $(CXXTARGET)
CFLAGS_WIN32APP  = -w4 -wcd=726 -e25 -obmiklrtf+ -bm -mf -5r -bt=os2 -zq -fp5 -fpi87        $(CTARGET)
CXXFLAGS_WIN32APP= -w4 -wcd=726 -e25 -obmiklrtf+ -bm -mf -5r -bt=os2 -zq -fp5 -fpi87        $(CXXTARGET)
...
LDFLAGS          = option maxe=125, caseexact, quiet, symfile, nodefaultlibs  LIBPath $(WATCOM)\lib386\os2;$(WATCOM)\lib386 $(LDSTACK)
LDFLAGS_ODINCRT  = option maxe=125, caseexact, quiet, symfile  LIBPath $(WATCOM)\lib386\os2;$(WATCOM)\lib386                $(LDSTACK)
