# $Id: setup.os2relmscv6.mk,v 1.5 2002-04-30 06:20:04 bird Exp $
...
CC_FLAGS=/nologo /c /DDEBUG /DOS2 /W0 $(CC_SEGS) /G2s /Ogeitln $(CC_DEFINES) $(ALL_DEFINES) $(BUILD_DEFINES) $(CC_INCLUDES) $(ALL_INCLUDES) /I$(PATH_INCLUDES)
