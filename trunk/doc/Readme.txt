...
For the curiose user, Win32k.sys will probably work with OS/2 2.11 too.
I've not test this. But I have run successful Ring-3 tests against the
lates 2.11 fixpack kernels.
