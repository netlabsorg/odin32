/* $Id: guclip.c,v 1.2 2001-09-05 14:30:30 bird Exp $ */
/*
...
**
** $Header: /home/ktk/tmp/odin/odin32xp/src/opengl/glide/cvg/glide/guclip.c,v 1.2 2001-09-05 14:30:30 bird Exp $
** $Log: guclip.c,v $
           ...
           (const GrVertex *a, const GrVertex *b, const GrVertex *c ))
{
  ...
  defined(__GNUC__) || defined(__MWERKS__) || defined(__OS2__)
