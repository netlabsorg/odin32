/* $Id: initterm.cpp,v 1.1 1999-11-08 22:10:00 hugh Exp $ */
                                   ...
                                   ulFlag)
{
   ...
   switch (ulFlag)
   {
      case 0 :
      {
        ...
        DosQueryModuleName(hModule, CCHMAXPATH, wing32Path);
        char *endofpath = strrchr(wing32Path, '\\');
        if(endofpath)
          *(endofpath+1) = 0;
