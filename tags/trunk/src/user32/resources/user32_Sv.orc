...
{
 MENUITEM "&Återställ\tAlt-F5", 61728
 MENUITEM "&Flytta\tAlt-F7", 61456
 MENUITEM "&Storlek\tAlt-F8", 61440
 MENUITEM "Mi&nimera\tAlt-F9", 61472
 MENUITEM "Ma&ximera\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Avsluta\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Byt till ...\tCtrl-Esc", 61744
