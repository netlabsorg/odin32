...
{
 MENUITEM "&Vorig formaat\tAlt-F5", 61728
 MENUITEM "Ve&rplaatsen\tAlt-F7", 61456
 MENUITEM "&Grootte\tAlt-F8", 61440
 MENUITEM "Mi&nimaliseren\tAlt-F9", 61472
 MENUITEM "&Maximaliseren\tAlt-F10", 61488
 MENUITEM SEPARATOR
 MENUITEM "&Sluiten\tAlt-F4", 61536
 MENUITEM SEPARATOR
 MENUITEM "&Overschakelen naar ...\tCtrl-Esc", 61744
