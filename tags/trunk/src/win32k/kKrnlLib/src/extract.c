/* $Id: extract.c,v 1.1 2002-03-10 02:45:54 bird Exp $
 *
...
int main(int argc, char **argv)
{
    ...
    else
    {
        ...
        #ifndef DB_ASM
            printf16("/* $Id: extract.c,v 1.1 2002-03-10 02:45:54 bird Exp $\n"
                     "*\n"
