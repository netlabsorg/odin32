...
extern ICOM_VTABLE(IDirectPlayLobby)  directPlayLobbyWVT;
extern ICOM_VTABLE(IDirectPlayLobby2) directPlayLobby2WVT;
extern ICOM_VTABLE(IDirectPlayLobby3) directPlayLobby3WVT;

extern ICOM_VTABLE(IDirectPlayLobby)  directPlayLobbyAVT;
extern ICOM_VTABLE(IDirectPlayLobby2) directPlayLobby2AVT;
extern ICOM_VTABLE(IDirectPlayLobby3) directPlayLobby3AVT;
  ...
  IUnknown* pUnk)
{
  ...
  lpConn = (LPDPLCONNECTION)HeapAlloc( GetProcessHeap(), HEAP_ZERO_MEMORY, dwConnSize );
  ...
  DWORD dwFlags )
{
  ...
  if( !(void*)lpEnumAddressTypeCallback || !*(int*)lpEnumAddressTypeCallback )
  {
     return DPERR_INVALIDPARAMS;
  }
  ...
  DWORD dwFlags )
{
  ...
  if( !(void*)lpEnumLocalAppCallback || !*(int*)lpEnumLocalAppCallback )
  {
     return DPERR_INVALIDPARAMS;
  }
...
struct ICOM_VTABLE(IDirectPlayLobby) directPlayLobbyWVT =
{
  ICOM_MSVTABLE_COMPAT_DummyRTTIVALUE
...
struct ICOM_VTABLE(IDirectPlayLobby2) directPlayLobby2AVT =
{
  ICOM_MSVTABLE_COMPAT_DummyRTTIVALUE
...
struct ICOM_VTABLE(IDirectPlayLobby2) directPlayLobby2WVT =
{
  ICOM_MSVTABLE_COMPAT_DummyRTTIVALUE
