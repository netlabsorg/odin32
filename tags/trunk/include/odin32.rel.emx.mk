# $Id: odin32.rel.emx.mk,v 1.3 2001-04-02 09:54:45 sandervl Exp $
...
CFLAGS           = -mprobe -pg -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CTARGETFLAGS)
CXXFLAGS         = -mprobe -pg -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS)
CXXFLAGS_ODINCRT = -mprobe -pg -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS)
CFLAGS_WIN32APP  = -mprobe -pg -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CTARGETFLAGS)
CXXFLAGS_WIN32APP= -mprobe -pg -c -pipe -Wall -Zmt -s -O2 -mcpu=i586 $(CXXTARGETFLAGS) $(CXXEXCEPTIONS)
