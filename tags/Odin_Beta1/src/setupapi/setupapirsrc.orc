...
1 VERSIONINFO
 FILEVERSION 0x04, 0x00, 0x0565, 0x0123
 PRODUCTVERSION 0x04, 0x00, 0x0565, 0x0123
 FILEFLAGSMASK 0x3fL
 FILEFLAGS 0xaL
 FILEOS 0x10001L
 FILETYPE 0x1L
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription", "SETUPAPI System dll\0"
            VALUE "FileVersion", "4.00\0"
            VALUE "InternalName", "SETUPAPI\0"
            VALUE "LegalCopyright", "Copyright (C) 1999-2001\0"
            VALUE "LegalTrademarks", "\0"
            VALUE "OriginalFilename", "SETUPAPI.DLL\0"
            VALUE "ProductName", "Odin32 - SETUPAPI\0"
