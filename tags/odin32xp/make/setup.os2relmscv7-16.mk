# $Id: setup.os2relmscv7-16.mk,v 1.2 2002-09-20 04:10:05 bird Exp $

# ---OS2, RELEASE, MSCV7-------------------------
ENV_NAME="OS/2, Release, Microsoft C v7.0 16-bit"
ENV_STATUS=OK
!if "$(ENV_ENVS)" == ""
ENV_ENVS=vac308 mscv7-16
!else
ENV_ENVS_FORCE=vac308 mscv7-16
!endif
ENV_16BIT = 16
