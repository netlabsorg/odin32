...
#ifdef __WIN32OS2__
            MultiByteToWideChar( CP_ACP, 0, item->pszText, -1, (LPWSTR)tvItem->pszText, len);
#else
...
#ifdef __WIN32OS2__
            MultiByteToWideChar( CP_ACP, 0, editItem->pszText, -1, (LPWSTR)tvdi.item.pszText, len);
            tvdi.item.cchTextMax = len;
#else
