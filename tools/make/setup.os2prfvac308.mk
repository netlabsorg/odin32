# $Id: setup.os2prfvac308.mk,v 1.1.2.2 2002-03-10 05:31:18 bird Exp $
...
CC_FLAGS=/Q /DDEBUG /DOS2 /Ti+ /O- /Gh+ /Ss+ /C+ $(CC_SEGS) $(CC_DEFINES) $(ALL_DEFINES) $(CC_INCLUDES) $(ALL_INCLUDES) /I$(PATH_INCLUDE)
...
CXX_FLAGS=/Q /DDEBUG /DOS2 /Ti+ /O- /Gh+ /Ss+ /C+ $(CXX_SEGS) $(CXX_DEFINES) $(ALL_DEFINES) $(CXX_INCLUDES) $(ALL_INCLUDES) /I$(PATH_INCLUDE)
